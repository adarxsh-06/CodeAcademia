...
function App() {
  ...
  return (
    <div className="w-screen min-h-screen bg-[#141414] flex flex-col font-inter">
      <Navbar />

      {/* go upward arrow */}
      <button
        onClick={() => window.scrollTo(0, 0)}
        className={`bg-[#FFE83D] hover:bg-[#FFF970] hover:scale-110 p-3 text-lg text-black rounded-2xl fixed right-3 z-10 duration-500 ease-in-out ${
