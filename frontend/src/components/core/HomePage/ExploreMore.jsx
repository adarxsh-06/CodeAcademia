    ...
    <div>
      ...
      <div>
        <div className="text-3xl lg:text-4xl font-semibold text-center my-10">
          ...
          <p className="text-center text-[#838894] text-base lg:text-lg font-semibold mt-1">
          ...
          return (
            <div
              className={` text-[16px] flex flex-row items-center gap-2 ${
                currentTab === ele
                  ? "bg-[#141414] text-[#F1F2FF] font-medium"
                  : "text-[#999DAA]"
              } px-7 py-[7px] rounded-full transition-all duration-200 cursor-pointer hover:bg-[#141414] hover:text-[#F1F2FF]`}
              key={index}
