    ...
    <div>
      <div className="flex flex-col lg:flex-row gap-15 items-center">
          ...
          {timeline.map((element, index) => {
            return (
              <div className="flex flex-row gap-6" key={index}>
                <div className="w-[50px] h-[50px] rounded-full bg-[#ECF5FF]00 flex justify-center items-center">
        ...
        <motion.div
          ...
          whileInView={"show"}
          viewport={{ once: false, amount: 0.1 }}
          className="relative shadow-[#118AB2]"
        >
          <Img
            src={timelineImage}
            alt="timelineImage"
          ...
          <div
            className=" absolute bg-[#014A32] flex flex-row text-white uppercase py-7
          ...
          >
            <div className="flex flex-row gap-5 items-center border-r border-[#05A77B] px-7">
              ...
              <p className="text-[#05A77B] text-xs lg:text-sm">
                Years of Experience
              </p>
            </div>
