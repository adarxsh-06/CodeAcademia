  ...
  return (
    <div>
      ...
      <Table className="rounded-xl border-2 border-[#F1F2FF]00 ">
        <Thead>
          <Tr className="flex gap-x-10 rounded-t-md border-b border-b-[#F1F2FF]00 px-6 py-2">
            <Th className="flex-1 text-left text-sm font-medium uppercase text-[#AFB2BF]">
              Instructors : {instructorsCount}
            </Th>

            <Th className=" ml-4 text-sm font-medium uppercase text-[#AFB2BF]">
              Status
            </Th>
          </Tr>
        </Thead>
              ...
              >
                ...
                {instructor.courses.length ? (
                  <Tr className="flex gap-x-10 px-6 pb-5">
                    <p className="text-[#FFF970] ">Built Courses</p>
