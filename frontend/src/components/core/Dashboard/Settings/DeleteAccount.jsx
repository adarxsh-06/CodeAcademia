...
export default function DeleteAccount() {
  ...
  return (
    <>
      <div className="my-10 flex flex-row gap-x-5 rounded-md border-[1px] border-[#691432] bg-[#340019] p-8 px-6 sm:px-12">
        ...
        <div className="flex flex-col ">
          ...
          <div className="sm:w-3/5 text-[#FBC7D1] flex flex-col gap-3 mt-1">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <button
              type="button"
              className="w-fit italic text-[#D43D63]  "
              onClick={() =>
                check &&
