...
export default function MyProfile() {
  ...
  return (
    <>
      <h1 className="mb-14 text-4xl font-medium text-[#F1F2FF] font-boogaloo text-center sm:text-left">
        {" "}
        My Profile
      </h1>

      <div className="flex items-center justify-between rounded-2xl border-[1px] border-[#2C333F] bg-[#161D29] p-8 px-3 sm:px-12">
      ...
      <div className="my-10 flex flex-col gap-y-10 rounded-2xl border-[1px] border-[#2C333F] bg-[#161D29] p-8 px-7 sm:px-12">
        ...
        <p
          className={`${
            user?.additionalDetails?.about ? "text-[#F1F2FF]" : "text-[#717171]"
          } text-sm font-medium`}
        >
        ...
        <div className="flex max-w-[500px] justify-between ">
          <div className="flex flex-col gap-y-5">
            <div>
              ...
              <p className="text-sm font-semibold text-[#F1F2FF] capitalize">
                {user?.firstName}
              </p>
            </div>
            <div>
              <p className="mb-2 text-sm text-[#424854]">Account Type</p>
              <p className="text-sm font-semibold text-[#F1F2FF] capitalize">
                {user?.accountType}
              </p>
            </div>
