...
export default function CourseBuilderForm() {
  ...
  return (
    <div className="space-y-8 rounded-2xl border-[1px] border-[#2C333F] bg-[#161D29] p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="flex items-end gap-x-4">
          <IconBtn
            ...
            outline={true}
          >
            <IoAddCircleOutline size={20} className="text-[#FFF970]" />
          </IconBtn>
      ...
      <div className="flex justify-end gap-x-3">
        <button
          onClick={goBack}
          className={`rounded-md bg-[#838894] py-[8px] px-[20px] font-semibold text-[#141414]`}
        >
          Back
        </button>
