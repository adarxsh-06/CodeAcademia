    ...
    >
      ...
      <div className="flex flex-col space-y-2">
        ...
        <div className="relative">
          ...
          />
          <HiOutlineCurrencyRupee className="absolute left-3 top-1/2 -translate-y-1/2 text-2xl text-[#717171]" />
        </div>
        {errors.coursePrice && (
          <span className="ml-2 text-xs text-[#EF476F]">
      ...
      <div className="flex justify-end gap-x-2">
        {editCourse && (
          <button
            ...
            disabled={loading}
            className="flex cursor-pointer items-center gap-x-2 rounded-md py-[8px] px-[20px] font-semibold text-[#141414] bg-[#838894] hover:bg-[#141414] hover:text-[#838894] duration-300"
          >
