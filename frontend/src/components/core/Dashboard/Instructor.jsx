  ...
  const skItem = () => {
    return (
      <div className="mt-5 w-full flex flex-col justify-between  rounded-xl ">
        <div className="flex border p-4 border-[#424854] ">
        ...
        <div className="flex flex-col gap-y-6  mt-5">
          <div className="flex justify-between">
            <p className="text-lg font-bold text-[#F1F2FF] pl-5">
              Your Courses
            </p>
            <Link to="/dashboard/my-courses">
              <p className="text-xs font-semibold text-[#FFF970] hover:underline pr-5">
                View All
              </p>
            </Link>
          </div>
  ...
  return (
    <div>
      <div className="space-y-2">
        <h1 className="text-2xl font-bold text-[#F1F2FF] text-center sm:text-left">
          Hii {user?.firstName} 👋
        </h1>
        <p className="font-medium text-[#999DAA] text-center sm:text-left">
      ...
      {loading ? (
        ...
        <div>
          ...
          <div className="rounded-md bg-[#161D29] p-6">
            <div className="flex items-center justify-between">
              ...
              <Link to="/dashboard/my-courses">
                <p className="text-xs font-semibold text-[#FFF970] hover:underline">
                  View All
                </p>
              </Link>
            </div>
        ...
        <div className="mt-20 rounded-md bg-[#161D29] p-6 py-20">
          ...
          <Link to="/dashboard/add-course">
            <p className="mt-1 text-center text-lg font-semibold text-[#FFF970]">
              Create a course
            </p>
          </Link>
        </div>
