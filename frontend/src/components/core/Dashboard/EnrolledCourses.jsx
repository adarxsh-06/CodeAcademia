...
export default function EnrolledCourses() {
  ...
  const sklItem = () => {
    return (
      <div className="flex border border-[#2C333F] px-5 py-3 w-full">
  ...
  if (enrolledCourses?.length == 0) {
    return (
      <p className="grid h-[50vh] w-full place-content-center text-center text-[#F1F2FF] text-3xl">
  ...
  return (
    <>
      <div className="text-4xl text-[#F1F2FF] font-boogaloo text-center sm:text-left">
        Enrolled Courses
      </div>
      {
        <div className="my-8 text-[#F1F2FF]">
          {/* Headings */}
          <div className="flex rounded-t-2xl bg-[#161D29] ">
          ...
          {enrolledCourses?.map((course, i, arr) => (
            <div
              className={`flex flex-col sm:flex-row sm:items-center border border-[#2C333F] ${
