...
const Navbar = () => {
  ...
  return (
    <nav
      className={`z-[10] flex h-14 w-full items-center justify-center border-b-[1px] border-b-[#2C333F] text-white translate-y-0 transition-all ${showNavbar} `}
    >
      ...
      <div className="flex w-11/12 max-w-maxContent items-center justify-between ">
        {/* logo */}
        <Link to="/">
          <img src={CodeAcademia_Logo} width={100} height={42} loading='lazy'className="rounded-full" />
                ...
                >
                  ...
                  <div
                    className="invisible absolute left-[50%] top-[50%] z-[1000] flex w-[200px] translate-x-[-50%] translate-y-[3em] 
                                                    flex-col rounded-lg bg-[#F1F2FF] p-4 text-[#141414] opacity-0 transition-all duration-150 group-hover:visible 
        ...
        <div className="flex gap-x-4 items-center">
          ...
          {token === null && (
            <Link to="/login">
              {/* <button className='border border-[#2C333F] bg-[#161D29] px-[12px] py-[8px] text-[#AFB2BF] rounded-md focus:outline-8 outline-[#FFF970]'> */}
              <button
                className={` px-[12px] py-[8px] text-[#AFB2BF] rounded-md 
                                 ${
                                   matchRoute("/login")
                                     ? "border-[2.5px] border-[#FFF970]"
                                     : "border border-[#2C333F] bg-[#161D29]"
                                 } `}
              >
                Log in
              </button>
          ...
          {token === null && (
            <Link to="/signup">
              {/* <button className='border border-[#2C333F] bg-[#161D29] px-[12px] py-[8px] text-[#AFB2BF] rounded-md'> */}
              <button
                className={` px-[12px] py-[8px] text-[#AFB2BF] rounded-md 
                                 ${
                                   matchRoute("/signup")
