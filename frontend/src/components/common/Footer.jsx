...
// Images
import CodeAcademia_Logo from "../../assets/Logo/CodeAcademia_Logo.jpeg";
...
const Footer = () => {
  return (
    <div className="bg-[#161D29] mx-7 rounded-3xl mb-10">
      <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-[#717171] leading-6 mx-auto relative py-14">
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-[#2C333F]">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-[#2C333F] pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              <img src={CodeAcademia_Logo} alt="Logo" loading="lazy" width={120} className="object-contain rounded-full" />
              <h1 className="text-[#F1F2FF]0 font-semibold text-[16px]">
                Company
              </h1>
              <div className="flex flex-col gap-2">
                {["About", "Careers", "Affiliates"].map((ele, i) => {
                  return (
                    <div
                      key={i}
                      className="text-[14px] cursor-pointer hover:text-[#F1F2FF]0 transition-all duration-200"
                    >
            ...
            <div className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
              ...
              <h1 className="text-[#F1F2FF]0 font-semibold text-[16px] mt-7">
                Support
              </h1>
              <div className="text-[14px] cursor-pointer hover:text-[#F1F2FF]0 transition-all duration-200 mt-2">
      ...
      {/* bottom footer */}
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-[#717171] mx-auto pb-14 text-sm">
        {/* Section 1 */}
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
              ...
              return (
                <div
                  ...
                  className={` ${
                   ...
                   px-3 cursor-pointer hover:text-[#F1F2FF]0 transition-all duration-200`}
                >
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link
                to="https://github.com/adarxsh-06"
                target="__blank"
            ...
            <span> © 2025 CodeAcademia</span>
          </div>

          <div className="flex items-center">
            <a
              href="https://www.linkedin.com/in/adarshpandey0608/"
              className="text-white p-3 hover:bg-[#2C333F] rounded-full duration-300"
              target="_blank"
            ...
            <a
              href="https://www.github.com/adarxsh-06"
              className="text-white p-3 hover:bg-[#2C333F] rounded-full duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
