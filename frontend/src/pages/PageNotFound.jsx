        ...
        <div>
          <div>
            <div className="text-center">
              ...
              <div className="-mt-12 ">
                <h3 className="text-4xl mb-1 ">Look like you're lost</h3>

                <p>The page you are looking for not available!</p>

                <Link
                  to="/"
                  className=" py-[13px] px-10 text-lg bg-[#05BF8E] hover:bg-[#049069] my-5 inline-block rounded-full font-semibold duration-300"
                >
                  Home
                </Link>
              </div>
