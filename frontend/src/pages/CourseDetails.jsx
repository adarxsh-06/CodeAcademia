        ...
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-cente py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            <div
              ...
              onClick={() => navigate(-1)}
            >
              <GiReturnArrow className="w-10 h-10 text-[#E7C009] hover:text-[#FFF970] cursor-pointer" />
            </div>
            ...
            {/* Course data */}
            <div
              className={`mb-5 flex flex-col justify-center gap-4 py-5 text-lg text-[#F1F2FF]`}
            >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {tag &&
                tag.map((item, ind) => (
                  <p
                    key={ind}
                    className="bg-[#FFF970] p-[2px] text-black rounded-full text-center font-semibold"
                  >
                    {item}
                  </p>
                ))}
