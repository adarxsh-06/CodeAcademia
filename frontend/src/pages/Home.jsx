...
const Home = () => {
  ...
  const categoryID = "67da5136ff10c81a56e16046"; // hard coded
    ...
    <React.Fragment>
      ...
      <div className=" ">
        ...
        <div className="relative h-[450px] md:h-[550px] justify-center mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white ">
          <Link to={"/signup"}>
            <div
              className="z-0 group p-1 mx-auto rounded-full bg-[#161D29] font-bold text-[#999DAA]
                                        transition-all duration-200 hover:scale-95 w-fit"
            >
              <div
                className="flex flex-row items-center gap-2 rounded-full px-10 py-[5px]
                              transition-all duration-200 group-hover:bg-[#141414]"
              >
          ...
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.1 }}
            className=" mt-4 w-[90%] text-center text-base lg:text-lg font-bold text-[#838894]"
          >
            ...
            <div className="flex flex-col lg:flex-row gap-5 mb-10 mt-[95px]">
              ...
              <div className="flex flex-col gap-10 w-full lg:w-[40%] items-start">
                <div className="text-[16px]">
                  CodeAcademia dictates its own terms. Today,
        ...
        {/*Section 3 */}
        <div className="mt-14 w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 first-letter bg-[#141414] text-white">
          <InstructorSection />

          {/* Reviws from Other Learner */}
          <h1 className="text-center text-3xl lg:text-4xl font-semibold mt-8 flex justify-center items-center gap-x-3">
            Reviews from other learners{" "}
            <MdOutlineRateReview className="text-[#FFE83D]" />
          </h1>
          <ReviewSlider />
        </div>
