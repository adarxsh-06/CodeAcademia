      ...
      {loading ? (
        ...
        <div className="max-w-[500px] p-4 lg:p-8">
          ...
          <form onSubmit={handleVerifyAndSignup}>
            <OtpInput
              ...
              renderInput={(props) => (
                <input
                  ...
                  className="w-[48px] lg:w-[60px] border-0 bg-[#161D29] rounded-[0.5rem] text-[#F1F2FF] aspect-square text-center focus:border-0 focus:outline-2 focus:outline-[#FFF970]"
                />
              )}
              containerStyle={{
            ...
            <button
              type="submit"
              className="w-full bg-[#FFF970] py-[12px] px-[12px] rounded-[8px] mt-6 font-medium text-[#141414]"
            >
              Verify Email
            </button>
          </form>
